...
@interface Smith_Carl_Project2Object : KrollCoverageObject {
#else
@interface Smith_Carl_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Carl_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Carl_Project2Object *_smith_carl_project2;
    KrollObject* console;
	BOOL shutdown;
