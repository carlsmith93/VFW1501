...
//@interface Smith_Carl_Project2Object : NSObject
//@end

@interface Smith_Carl_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Smith_Carl_Project2Object class]])
		{
			for (NSString *key in [[(Smith_Carl_Project2Object*)o modules] allKeys])
			{
