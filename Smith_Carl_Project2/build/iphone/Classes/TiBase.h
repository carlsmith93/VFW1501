...
// in simulator we redefine to format for Smith_Carl_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_carl_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_carl_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Carl_Project2NativeItemNone = -1, 
	UISmith_Carl_Project2NativeItemSpinner = -2,
	UISmith_Carl_Project2NativeItemProgressBar = -3,
	
	UISmith_Carl_Project2NativeItemSlider = -4,
	UISmith_Carl_Project2NativeItemSwitch = -5,
	UISmith_Carl_Project2NativeItemMultiButton = -6,
	UISmith_Carl_Project2NativeItemSegmented = -7,
	
	UISmith_Carl_Project2NativeItemTextView = -8,
	UISmith_Carl_Project2NativeItemTextField = -9,
	UISmith_Carl_Project2NativeItemSearchBar = -10,
	
	UISmith_Carl_Project2NativeItemPicker = -11,
	UISmith_Carl_Project2NativeItemDatePicker = -12,
	
	UISmith_Carl_Project2NativeItemInfoLight = -13,
	UISmith_Carl_Project2NativeItemInfoDark = -14,
	
	UISmith_Carl_Project2NativeItemDisclosure = -15,
	
	UISmith_Carl_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Carl_Project2 instances of
