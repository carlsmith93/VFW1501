 ...
 * to send analytic data that can be viewed on the Smith_Carl_Project3 Dashboard.
 *
 * For information on getting started with Smith_Carl_Project3 Platform Services,
