...
@interface Smith_Carl_Project3Object : KrollCoverageObject {
#else
@interface Smith_Carl_Project3Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Carl_Project3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Carl_Project3Object *_smith_carl_project3;
    KrollObject* console;
	BOOL shutdown;
