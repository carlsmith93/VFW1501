...
//@interface Smith_Carl_Project3Object : NSObject
//@end

@interface Smith_Carl_Project3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Smith_Carl_Project3Object class]])
		{
			for (NSString *key in [[(Smith_Carl_Project3Object*)o modules] allKeys])
			{
