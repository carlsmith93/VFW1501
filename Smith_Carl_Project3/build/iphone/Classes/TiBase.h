...
// in simulator we redefine to format for Smith_Carl_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_carl_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_carl_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Carl_Project3NativeItemNone = -1, 
	UISmith_Carl_Project3NativeItemSpinner = -2,
	UISmith_Carl_Project3NativeItemProgressBar = -3,
	
	UISmith_Carl_Project3NativeItemSlider = -4,
	UISmith_Carl_Project3NativeItemSwitch = -5,
	UISmith_Carl_Project3NativeItemMultiButton = -6,
	UISmith_Carl_Project3NativeItemSegmented = -7,
	
	UISmith_Carl_Project3NativeItemTextView = -8,
	UISmith_Carl_Project3NativeItemTextField = -9,
	UISmith_Carl_Project3NativeItemSearchBar = -10,
	
	UISmith_Carl_Project3NativeItemPicker = -11,
	UISmith_Carl_Project3NativeItemDatePicker = -12,
	
	UISmith_Carl_Project3NativeItemInfoLight = -13,
	UISmith_Carl_Project3NativeItemInfoDark = -14,
	
	UISmith_Carl_Project3NativeItemDisclosure = -15,
	
	UISmith_Carl_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Carl_Project3 instances of
