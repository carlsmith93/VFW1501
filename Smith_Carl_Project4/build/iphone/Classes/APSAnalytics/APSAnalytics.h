 ...
 * to send analytic data that can be viewed on the Smith_Carl_Project4 Dashboard.
 *
 * For information on getting started with Smith_Carl_Project4 Platform Services,
