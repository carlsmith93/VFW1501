...
@interface Smith_Carl_Project4Object : KrollCoverageObject {
#else
@interface Smith_Carl_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Carl_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Carl_Project4Object *_smith_carl_project4;
    KrollObject* console;
	BOOL shutdown;
