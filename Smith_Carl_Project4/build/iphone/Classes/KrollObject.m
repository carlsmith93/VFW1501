...
//@interface Smith_Carl_Project4Object : NSObject
//@end

@interface Smith_Carl_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Smith_Carl_Project4Object class]])
		{
			for (NSString *key in [[(Smith_Carl_Project4Object*)o modules] allKeys])
			{
