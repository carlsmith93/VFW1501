...
// in simulator we redefine to format for Smith_Carl_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_carl_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_carl_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Carl_Project4NativeItemNone = -1, 
	UISmith_Carl_Project4NativeItemSpinner = -2,
	UISmith_Carl_Project4NativeItemProgressBar = -3,
	
	UISmith_Carl_Project4NativeItemSlider = -4,
	UISmith_Carl_Project4NativeItemSwitch = -5,
	UISmith_Carl_Project4NativeItemMultiButton = -6,
	UISmith_Carl_Project4NativeItemSegmented = -7,
	
	UISmith_Carl_Project4NativeItemTextView = -8,
	UISmith_Carl_Project4NativeItemTextField = -9,
	UISmith_Carl_Project4NativeItemSearchBar = -10,
	
	UISmith_Carl_Project4NativeItemPicker = -11,
	UISmith_Carl_Project4NativeItemDatePicker = -12,
	
	UISmith_Carl_Project4NativeItemInfoLight = -13,
	UISmith_Carl_Project4NativeItemInfoDark = -14,
	
	UISmith_Carl_Project4NativeItemDisclosure = -15,
	
	UISmith_Carl_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Carl_Project4 instances of
