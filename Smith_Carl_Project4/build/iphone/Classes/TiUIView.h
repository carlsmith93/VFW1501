...
/**
 Base class for all Smith_Carl_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Smith_Carl_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
