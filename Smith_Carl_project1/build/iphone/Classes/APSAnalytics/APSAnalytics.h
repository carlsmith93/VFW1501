 ...
 * to send analytic data that can be viewed on the Smith_Carl_project1 Dashboard.
 *
 * For information on getting started with Smith_Carl_project1 Platform Services,
