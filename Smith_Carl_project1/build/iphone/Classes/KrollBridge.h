...
@interface Smith_Carl_project1Object : KrollCoverageObject {
#else
@interface Smith_Carl_project1Object : KrollObject {
#endif
@private
...
extern NSString * Smith_Carl_project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Smith_Carl_project1Object *_smith_carl_project1;
    KrollObject* console;
	BOOL shutdown;
