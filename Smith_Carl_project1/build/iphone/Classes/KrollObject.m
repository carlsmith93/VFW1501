...
//@interface Smith_Carl_project1Object : NSObject
//@end

@interface Smith_Carl_project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Smith_Carl_project1Object class]])
		{
			for (NSString *key in [[(Smith_Carl_project1Object*)o modules] allKeys])
			{
