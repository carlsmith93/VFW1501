...
// in simulator we redefine to format for Smith_Carl_project1 Developer console
...
{\
	NSString * exceptionName = [@"org.smith_carl_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.smith_carl_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISmith_Carl_project1NativeItemNone = -1, 
	UISmith_Carl_project1NativeItemSpinner = -2,
	UISmith_Carl_project1NativeItemProgressBar = -3,
	
	UISmith_Carl_project1NativeItemSlider = -4,
	UISmith_Carl_project1NativeItemSwitch = -5,
	UISmith_Carl_project1NativeItemMultiButton = -6,
	UISmith_Carl_project1NativeItemSegmented = -7,
	
	UISmith_Carl_project1NativeItemTextView = -8,
	UISmith_Carl_project1NativeItemTextField = -9,
	UISmith_Carl_project1NativeItemSearchBar = -10,
	
	UISmith_Carl_project1NativeItemPicker = -11,
	UISmith_Carl_project1NativeItemDatePicker = -12,
	
	UISmith_Carl_project1NativeItemInfoLight = -13,
	UISmith_Carl_project1NativeItemInfoDark = -14,
	
	UISmith_Carl_project1NativeItemDisclosure = -15,
	
	UISmith_Carl_project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Smith_Carl_project1 instances of
