...
//Rare exceptions to indicate a bug in the _smith_carl_project1 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Smith_Carl_project1 proxies.
 */
