...
/**
 Base class for all Smith_Carl_project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Smith_Carl_project1 view hierarchy (such as wrapped iOS UIViews) was touched.
